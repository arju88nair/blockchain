...
class Blockchain(object):
    ...
    def new_transaction(self, sender, recipient, amount):
        ...
        # After new_transaction() adds a transaction to the list, it returns the index of the block which
        # the transaction will be added to—the next one to be mined. This will be useful later on,
